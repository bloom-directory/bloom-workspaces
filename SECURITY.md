...
No release in the `0.x` series is approved for funded wallet keys, seed phrases,
production signing credentials, private-registry secrets, or unrestricted public
egress. See the [threat model](docs/threat-model.md) and [public launch gates](docs/public-launch.md).
