...
export function issueChallenge(db: BloomDatabase, config: Config, ipHash: string) {
  ...
  return {
    ...
    statement: "Sign in to request a Bloom workspace. Transaction signing uses Bloom's Sealed Approval ceremony — you will approve each transaction through a secure local ceremony URL, never through this browser session.",
